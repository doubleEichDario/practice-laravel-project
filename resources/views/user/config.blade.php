            ...
            <div class="card">
                ...
                <div class="card-body">
                  <form method="POST" action="{{ route('user-update') }}" enctype="multipart/form-data">
                      ...
                      <!-- Surname input added. Author: Darío Hernández -->
                      <div class="form-group row">
                      ...
                      <!-- Nick input added. Author: Darío Hernández -->
                      <div class="form-group row">
                      ...
                      <!-- Avatar Image input added. Author: Darío Hernández -->
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              ...
                              <input id="image_path" type="file" class="float-right {{ $errors->has('image_path') ? ' is-invalid' : '' }}" name="image_path">
